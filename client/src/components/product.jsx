        ...
        <div id="myForm" className="userDataForm">
          ...
          <div className="registrationData">
            ...
            <input
              ...
              name="product_VAT"
              onChange={(event, element) => {
                setProduct_VAT(event.target.value);
              }}
            />
            <input
              type="text"
              placeholder="Product purchase prise"
              id="purshase_prise"
              className="usdata"
              name="purchase_prise"
              onChange={(event, element) => {
                setProduct_purchase_prise(event.target.value);
              }}
            />
            <input
              type="text"
              placeholder="Product sales prise"
              id="sales_prise"
              className="usdata"
              name="sales_prise"
              onChange={(event, element) => {
                setProduct_sales_prise(event.target.value);
              }}
            />
            <input
              type="text"
            ...
            <input
              ...
              name="product_image"
              onChange={(event, element) => {
                setProduct_image(event.target.value);
              }}
            />
            <input
              type="text"
              ...
              name="product_author"
              onChange={(event, element) => {
                setProduct_author(event.target.value);
              }}
            />
            <input
              type="text"
              ...
              name="product_genre"
              onChange={(event, element) => {
                setProduct_genre(event.target.value);
              }}
            />
            <input
              type="text"
            ...
            <input
              type="text"
              placeholder="Product release year"
              id="year"
              className="usdata"
              name="year"
              onChange={(event, element) => {
